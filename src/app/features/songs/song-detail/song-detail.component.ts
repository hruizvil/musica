    ...
    @if (song()) {
      <div class="w-full">
        <div class="lg:grid lg:grid-cols-[3fr_2fr] lg:gap-10 lg:items-start">
          ...
          <!-- LEFT COLUMN: title, lyrics -->
          <div class="space-y-8">

            <!-- Back link — mobile only (desktop version is in right column) -->
            <a routerLink="/musicas" class="lg:hidden flex items-center gap-1.5 text-sm font-medium text-stone-500 hover:text-capoeira-brown dark:hover:text-capoeira-gold px-3 py-1.5 rounded-lg hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors w-fit">
          ...
          <!-- RIGHT COLUMN: back (desktop), actions, audio, notes -->
          <div class="mt-8 lg:mt-0 space-y-6 lg:sticky lg:top-24">

            <!-- Back link — desktop only -->
            <a routerLink="/musicas" class="hidden lg:flex items-center gap-1.5 text-sm font-medium text-stone-500 hover:text-capoeira-brown dark:hover:text-capoeira-gold px-3 py-1.5 rounded-lg hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors w-fit">
              <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
              Músicas
            </a>
