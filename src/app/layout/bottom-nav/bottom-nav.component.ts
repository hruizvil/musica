...
@Component({
  ...
  template: `
    <nav aria-label="Navegação principal"
      class="no-print md:hidden fixed bottom-0 inset-x-0 z-40 border-t border-stone-200 dark:border-stone-800 bg-white/95 dark:bg-stone-950/95 backdrop-blur-md tabbar-inset">
      <ul class="flex items-stretch pt-1.5">

        <li class="flex-1">
          <a routerLink="/musicas" routerLinkActive #m="routerLinkActive"
             [attr.aria-current]="m.isActive ? 'page' : null"
             class="flex flex-col items-center justify-center gap-1 py-1.5 min-h-[3.5rem] transition-colors"
            ...
            <span class="text-[11px] font-semibold leading-none tracking-tight">Músicas</span>
          </a>
        </li>
        ...
        <li class="flex-1">
          <a routerLink="/toques" routerLinkActive #t="routerLinkActive"
            ...
            <span class="text-[11px] font-semibold leading-none tracking-tight">Toques</span>
          </a>
        </li>
        ...
        <li class="flex-1">
          <a routerLink="/roda" routerLinkActive #r="routerLinkActive"
             ...
             class="relative flex flex-col items-center justify-center gap-1 py-1.5 min-h-[3.5rem] transition-colors"
            ...
            <span class="text-[11px] font-semibold leading-none tracking-tight">Roda</span>
            @if (roda.count()) {
        ...
        <li class="flex-1">
          <a routerLink="/minhas" routerLinkActive #n="routerLinkActive"
            ...
            <span class="text-[11px] font-semibold leading-none tracking-tight">Minhas</span>
          </a>
        </li>
